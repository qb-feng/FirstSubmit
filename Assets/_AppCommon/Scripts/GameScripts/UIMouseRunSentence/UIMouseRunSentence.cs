...
public class UIMouseRunSentence : UIBaseLevelGame
{
    public static UIMouseRunSentence Instance { get; set; }
    ...
    private void SetShortSay()
    {
        ...
        for (int i = 0; i < 3; i++)
        {
            CreateUIItem("UIMouseRunStone", WordStonePos).AddComponent<UIMouseRunSentenceStone>().InitWord("", true);
        }
        for (int i = 0; i < saySentenceS.Length; i++)
        {
            CreateUIItem("UIMouseRunStone", WordStonePos).AddComponent<UIMouseRunSentenceStone>().InitWord(saySentenceS[i], false);
        }
        for (int i = 0; i < 3; i++)
        {
            CreateUIItem("UIMouseRunStone", WordStonePos).AddComponent<UIMouseRunSentenceStone>().InitWord("", true);
    ...
    private void SetLongSay()
    {
        ...
        for (int i = 0; i < 3; i++)
        {
            CreateUIItem("UIMouseRunStone", AskStonePosUp).AddComponent<UIMouseRunSentenceStone>().InitWord("", true);
        }
        for (int i = 0; i < 4; i++)
        {
            CreateUIItem("UIMouseRunStone", AskStonePosUp).AddComponent<UIMouseRunSentenceStone>().InitWord(saySentenceS[i], false);
        }
        for (int i = 0; i < 3; i++)
        {
            CreateUIItem("UIMouseRunStone", AskStonePosUp).AddComponent<UIMouseRunSentenceStone>().InitWord("", true);
        ...
        for (int i = 0; i < 2; i++)
        {
            CreateUIItem("UIMouseRunStone", AskStonePosDown).AddComponent<UIMouseRunSentenceStone>().InitWord("", true);
        }
        for (int i = 4; i < saySentenceS.Length; i++)
        {
            CreateUIItem("UIMouseRunStone", AskStonePosDown).AddComponent<UIMouseRunSentenceStone>().InitWord(saySentenceS[i], false);
        }
        for (int i = 0; i < 4; i++)
        {
            CreateUIItem("UIMouseRunStone", AskStonePosDown).AddComponent<UIMouseRunSentenceStone>().InitWord("", true);
    ...
    IEnumerator ShortMouseStar()
    {
        ...
        {
            if (WordStonePos.GetChild(i).GetComponent<UIMouseRunSentenceStone>().isWork == false)
            {
        ...
        {
            Instantiate(waitSelectStone[i], DownStoneAnswer).AddComponent<UIMouseRunSentenceStoneSelect>();
        }
        //梯子路径
        ...
        myMouse.AddComponent<UIMouseRunSentenceMouse>();
    ...
    IEnumerator LongMouseStar()
    {
        ...
        {
            if (AskStonePosUp.GetChild(i).GetComponent<UIMouseRunSentenceStone>().isWork == false)
            {
        ...
        {
            if (AskStonePosDown.GetChild(i).GetComponent<UIMouseRunSentenceStone>().isWork == false)
            {
    ...
    void CreatePath()
    {
        ...
        for (int i = 0; i < WordStonePos.childCount; i++)
        {
            if (WordStonePos.GetChild(i).GetComponent<UIMouseRunSentenceStone>().isWork)
            {
    ...
    public void AskCreatePath(bool UpOrDown)
    {
        if (UpOrDown)
        {
            ...
            for (int i = 0; i < AskStonePosUp.childCount; i++)
            {
                if (AskStonePosUp.GetChild(i).GetComponent<UIMouseRunSentenceStone>().isWork)
                {
        ...
        else
        {
            ...
            {
                if (AskStonePosDown.GetChild(i).GetComponent<UIMouseRunSentenceStone>().isWork)
                {
    ...
    private void EndShowSayText()
    {
        ...
        {
            if (DownStoneAnswer.GetChild(i).GetComponent<UIMouseRunSentenceStone>().isRightShow)
            {
