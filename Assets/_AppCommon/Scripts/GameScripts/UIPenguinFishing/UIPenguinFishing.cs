...
public class UIPenguinFishing : UIBaseLevelGame
{
    public static UIPenguinFishing Instance { get; set; }
    ...
    private void SetWord()
    {
        ...
        {
            CreateUIItem("UIPenguinFishingStone", WordStonePos).AddComponent<UIPenguinFishingStone>().InitWord(wordSort[i], false);
        }
        for (int i = 0; i < 4; i++)
        {
            CreateUIItem("UIPenguinFishingStone", WordStonePos).AddComponent<UIPenguinFishingStone>().InitWord("", true);
    ...
    void SetSay()
    {
        ...
        {            
            ...
            CreateUIItem("UIPenguinFishingStone", WordStonePos).AddComponent<UIPenguinFishingStone>().InitWord(saySentenceS[i], !saySentenceS[i].Contains(CurrentSay.MapWordString));
        }
        for (int i = 0; i < 4; i++)
        {
            CreateUIItem("UIPenguinFishingStone", WordStonePos).AddComponent<UIPenguinFishingStone>().InitWord("", true);
    ...
    IEnumerator AskMouseStar()
    {
        ...
        {
            if (AskStonePosUp.GetChild(i).GetComponent<UIPenguinFishingStone>().isWork == false)
            {
        ...
        {
            if (AskStonePosDown.GetChild(i).GetComponent<UIPenguinFishingStone>().isWork == false)
            {
        ...
        waitSelectStone[2].GetComponent<UIPenguinFishingStone>().answerStr = tempWord;
        waitSelectStone[2].GetComponent<UIPenguinFishingStone>().StoneText.text = tempWord;
        for (int i = 0; i < sAskDownSentence.Length; i++)
        {
        ...
        waitSelectStone[3].GetComponent<UIPenguinFishingStone>().answerStr = tempWord;
        waitSelectStone[3].GetComponent<UIPenguinFishingStone>().StoneText.text = tempWord;
    ...
    void CreatePath()
    {
        ...
        for (int i = 0; i < WordStonePos.childCount; i++)
        {
            if (WordStonePos.GetChild(i).GetComponent<UIPenguinFishingStone>().isWork)
            {
    ...
    public void AskCreatePath(bool UpOrDown)
    {
        if (UpOrDown)
        {
            ...
            for (int i = 0; i < AskStonePosUp.childCount; i++)
            {
                if (AskStonePosUp.GetChild(i).GetComponent<UIPenguinFishingStone>().isWork)
                {
        ...
        else
        {
            ...
            {
                if (AskStonePosDown.GetChild(i).GetComponent<UIPenguinFishingStone>().isWork)
                {                    
    ...
    private void EndShowSayText()
    {
        ...
        {
            if (DownStoneAnswer.GetChild(i).GetComponent<UIPenguinFishingStone>().isRightShow)
            {
