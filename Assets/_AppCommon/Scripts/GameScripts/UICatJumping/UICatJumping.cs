...
public class UICatJumping : UIBaseLevelGame {

    public static UICatJumping Instance { get; set; }
    void Awake()
    {
        Instance = this;
    }
    ...
    public override void Refresh()
    {
        ...
        InitCat();
        UpBoard=CreateUIItem("UICatJumpingSpringboard", Up);
        UpBoard.AddComponent<UICatJumpingMove>().Init(1, 2.5f);
        CenterBoard=CreateUIItem("UICatJumpingSpringboard", Center);
        CenterBoard.AddComponent<UICatJumpingMove>().Init(-1, 3f);
        DownBoard=CreateUIItem("UICatJumpingSpringboard", Down);
        DownBoard.AddComponent<UICatJumpingMove>().Init(1, 2f);
    ...
    void SetWord()
    {
        ...
        CreateUIItem("UICatJumpingFish", FishBirth).AddComponent<UICatJumpingFish>().Init(Words[0]);
        CreateUIItem("UICatJumpingFish", FishBirth).AddComponent<UICatJumpingFish>().Init(Words[1]);
        CreateUIItem("UICatJumpingFish", FishBirth).AddComponent<UICatJumpingFish>().Init(Words[2]);
    ...
    {
        CreateUIItem("UICatJumpingCat", CatBirth).AddComponent<UICatJumpingCat>();
    }
