...
public class UITrainWordItemAnswerCtrl : UIBaseSelectCtrl
{
    private UITrainWordItemNumAnswer m_parentItem;
    // Use this for initialization
    protected override void Start()
    {
        base.Start();
        m_isKinematics = false;
        m_parentItem = GetComponentInParent<UITrainWordItemNumAnswer>();
    }
