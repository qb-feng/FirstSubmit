...
public static class Options
{
	...
	public const string BUILD_REPORT_TOOL_DEFAULT_PATH = "Assets/_AppBase/_ThirdParty/BuildReport";
	...
	static string DefaultOptionsPath
	{
		get
		{
			return string.Format("{0}/_AppBase/_ThirdParty/BuildReport/{1}", Application.dataPath, SAVED_OPTIONS_FILENAME);
		}
	}
	...
	static bool IsBuildReportInRegularPaths
	{
		get
		{
            return Directory.Exists(string.Format("{0}/_AppBase/_ThirdParty/BuildReport", Application.dataPath)) ||
